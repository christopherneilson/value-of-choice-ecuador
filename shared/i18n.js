...
const ES = {
  ...
  "sim.paper": "<b>Artículo, datos reales ({grade}):</b> regla de distancia {dcl}% en lista · AD {dal}% en lista, {daf}% en primera opción · AD cierra {rec} del rango. <i>Cálculo de los autores a partir de los datos de postulación, no una cifra del artículo:</i> el {near}% pone primero a la más cercana.",
  ...
  "story.s4.p2": "Ese es el hallazgo central del artículo: el valor proviene de elicitar las preferencias, no de la elección del algoritmo. En el paso de la ciudad de Nueva York a la asignación coordinada, los refinamientos algorítmicos valían el 3,3% del rango de bienestar; en Manta, el 0,3%.",
  ...
  "story.s6.p1": "En Inicial 2 las ganancias son progresivas. Ordenando los barrios por la escolaridad de sus adultos, el artículo encuentra ganancias medias de +0,49 km equivalentes en el cuartil más bajo frente a +0,15 en el más alto, un contraste que se sostiene al remuestrear manzanas censales enteras. En Inicial 1 las medias por cuartil también descienden, de +0,79 a +0,59, pero ese contraste no se distingue de cero cuando el remuestreo respeta la manzana, así que el artículo no lee un gradiente en el grado de ingreso. El gradiente de Inicial 2 tampoco es una historia de menús más escasos: allí la escolaridad del barrio casi no guarda relación con la distancia a la escuela más cercana, y la mayor parte del contraste sobrevive al descontar la geografía. Lo que el artículo sí encuentra es que las familias de barrios con más escolaridad son más reacias a la distancia, de modo que ya obtenían lo que valoraban bajo la regla de distancia.",
  ...
  "story.r.nearest.s": "El {near}% pone primero a su escuela más cercana; las demás aceptan una mediana de {extra} km más de viaje por su primera opción {src1}<br>Artículo: en todos los niveles, más de una cuarta parte de las familias elige una escuela distinta de la más cercana y paga una mediana de 0,6 km por ello {src2}. El 65% que pone primero a la más cercana en este nivel es un cálculo de los autores a partir de los datos de postulación, no una cifra del artículo.",
  ...
  "story.r.whogains.h": "Progresivas en Inicial 2",
  "story.r.whogains.s": "Ganancia media por cuartil de escolaridad del barrio, del más bajo al más alto — Inicial 2: <b>+0,49, +0,38, +0,34, +0,15</b> km, un contraste entre extremos de +0,34 km (intervalo del 95%: +0,09 a +0,61 remuestreando manzanas censales; p de permutación = 0,010). Inicial 1: <b>+0,79, +0,68, +0,68, +0,59</b> km, un contraste de +0,20 km que cubre el cero cuando el remuestreo respeta la manzana (−0,01 a +0,37; p = 0,075), así que el artículo no lee un gradiente allí. En Inicial 1 gana el 51,8% de las familias, unos 1,4 km cada una {src2}<br>La <a href='../gains/'>página de quién gana</a> lo mapea familia por familia y pone el gradiente del artículo junto a lo que este modelo puede reproducir.",
  ...
  "toy.lede": "Tres familias, tres escuelas, un cupo cada una. Ordena las escuelas para <b>tu</b> familia y observa adónde te envían dos reglas de asignación. Bajo el <b>mecanismo de Boston</b> una escuela llena su cupo apenas alguien la pone primera, así que una familia que apunta alto y falla puede perder también su opción segura, y puede irle mejor <em>no</em> diciendo la verdad. Bajo la <b>aceptación diferida</b> nada queda fijo hasta el final, y en la configuración que analiza el artículo ninguna lista supera a la verdad. Por eso el artículo puede tratar las listas de Manta como lo que las familias realmente quieren.",
  ...
  "toy.all.note": "Bajo la aceptación diferida la lista sincera está entre las mejores que puedes entregar, hagan lo que hagan las demás familias: eso significa «a prueba de estrategias». El artículo lo demuestra para la configuración que analiza (prioridad de hermano estática, un solo cupo por escuela, desempate por escuela) y advierte que no se sigue sin más del resultado de manual, porque aquí listar una escuela es lo que te da prioridad en ella. La plataforma desplegada también ofrecía prioridad de hermano dinámica y vinculación familiar, que pueden romperlo; los contrafactuales del artículo desactivan ambas. Bajo Boston, si mentir conviene depende de lo que hagan los demás, que es justamente el juego de adivinanzas que un buen mecanismo elimina.",
  ...
  "lad.ny3.h": "Más allá de la eficiencia ordinal", "lad.ny3.b": "Desde la asignación ordinalmente Pareto-eficiente —que no es estable— hasta el óptimo utilitarista sin restricciones: 16,4% (3,11 millas). Sólo información cardinal podría cerrarla.",
  ...
  "pl.paper.body": "La forma construida del entorno tiene una señal robusta: más <b>edificios distintos</b> en 75 metros valen cerca de 0,3 km menos de viaje, significativo en los tres niveles; una mayor <b>superficie construida</b> total en ese radio, cerca de 0,4 km más, significativo condicional en la densidad construida. Describen la manzana circundante, no el campus. Los otros ocho son individualmente imprecisos. Y con los diez en el modelo —más rasgos aprendidos de las fotografías— <b>la mayor parte de la dispersión en la deseabilidad de las escuelas sigue sin explicarse</b>. La deseabilidad es real, grande y en gran medida idiosincrática; ningún conjunto parsimonioso de atributos observables sustituye a preguntarles a las familias. <span class=src>artículo, datos reales</span>",
  ...
  // ------------------------------------------------------------- who gains
  "wg.crumb.tag": "quién gana",
  "wg.h1": "¿Quién gana?",
  "wg.lede": "El promedio esconde a quién le toca. En el mapa, familia por familia: quiénes quedan mejor con la asignación por preferencias que con la regla de distancia y quiénes no. Este mercado sintético reproduce de cerca la incidencia del artículo: concentrada en la mitad de las familias, con la mayor parte del resto sin cambio. No reproduce el otro hallazgo distributivo del artículo, que en Inicial 2 las ganancias caen con la escolaridad del barrio, y el gráfico pone ambos lado a lado porque vale la pena saber por qué no puede.",
  "wg.grade": "Grado", "wg.colour": "Colorear por", "wg.colour.gain": "Ganancia de elegir", "wg.colour.ses": "Escolaridad del barrio",
  "wg.n": "{n} familias · {seats} cupos · promedio de {d} sorteos", "wg.running": "Corriendo los sorteos…",
  "wg.grad.h": "Ganancia por barrio: el artículo frente a este modelo",
  "wg.inc.h": "Concentrada, no uniforme",
  "wg.th.syn": "aquí", "wg.th.paper": "artículo",
  "wg.tip.km": "kilómetros equivalentes", "wg.tip.ses": "escolaridad del barrio", "wg.years": "años",
  "wg.leg.lose": "pierde terreno", "wg.leg.same": "prácticamente igual", "wg.leg.win": "gana", "wg.leg.school": "escuela",
  "wg.leg.ses": "menos años de escolaridad", "wg.leg.ses2": "más", "wg.leg.nod": "sin valor para esa celda",
  "wg.map.note": "Cada punto es una familia sintética, con tamaño y color según lo que vale para ella que se actúe sobre sus preferencias. El color satura en {cap} kilómetros equivalentes hacia cada lado.",
  "wg.map.note2": "Cada punto es una familia sintética, coloreada por los años medios de escolaridad de los adultos en las manzanas censales alrededor de su casa. Las familias generadas en la misma celda de 300 m comparten un valor.",
  "wg.x": "años medios de escolaridad en el barrio", "wg.y": "ganancia, km equivalentes",
  "wg.leg.q": "este modelo, por cuartil (±2 errores estándar)", "wg.leg.qp": "el artículo, por cuartil", "wg.leg.dec": "este modelo, por decil",
  "wg.grad.note": "En el artículo la ganancia cae con la escolaridad del barrio: <b>{paper} km</b> del cuartil más bajo al más alto (intervalo del 95%: {lo} a {hi}; p de permutación = {p}). En este modelo el mismo contraste es <b>{here} km</b>, más o menos {se}, es decir <b>no se distingue de cero</b>. Eso es lo que cabe esperar de una población sintética: ver abajo.",
  "wg.grad.note2": "El artículo imprime estas medias por cuartil para el nivel de ingreso pero <b>no lee un gradiente aquí</b>: el contraste es {paper} km y cubre el cero en cuanto el remuestreo respeta la manzana censal en la que varía el proxy (intervalo del 95%: {lo} a {hi}; p de permutación = {p}). El artículo acota el hallazgo a Inicial 2. En este modelo el contraste es {here} km, más o menos {se}.",
  "wg.grad.note4": "El gradiente del artículo para este grado es {paper} km y no se distingue de cero (intervalo del 95%: {lo} a {hi}); aquí la ganancia agregada también es casi nula, y el artículo acota su lectura distributiva solo a Inicial 2. En este modelo el contraste es {here} km, más o menos {se}.",
  "wg.scat.alt": "La ganancia de cada familia en kilómetros equivalentes frente a los años medios de escolaridad de su barrio, para {grade}. En este modelo sintético las medias por cuartil son {a}, {b}, {c} y {d} kilómetros, es decir planas; las del propio artículo caen con el nivel socioeconómico.",
  "wg.inc.head": "El <b>{g}%</b> de las familias gana, <b>{k} km</b> cada una. El <b>{s}%</b> queda igual bajo ambas reglas.",
  "wg.r.gain": "Ganan (más de 0,01 km)", "wg.r.same": "Prácticamente sin efecto", "wg.r.lose": "Pierden terreno",
  "wg.r.gainkm": "Ganancia media de quienes ganan, km", "wg.r.losekm": "Pérdida media de quienes pierden, km", "wg.r.mean": "Media sobre todos, km",
  "wg.inc.note": "Una familia cuenta como sin efecto cuando su ganancia media entre sorteos está a menos de 0,01 km de cero, el umbral del propio artículo. El artículo reporta el desglose completo para el nivel de ingreso y la proporción que pierde para los demás.",
  "wg.read.h": "Cómo leer esto",
  "wg.read.p1": "La ganancia es la utilidad de cada familia bajo la aceptación diferida menos su utilidad bajo la regla de distancia, en kilómetros equivalentes, promediada sobre los sorteos. Una familia gana cuando la regla que lee su lista la ubica donde prefiere frente a la escuela que le habría dado la proximidad. Los números positivos son el valor de que te pregunten.",
  "wg.read.p2": "El eje socioeconómico son los años medios de escolaridad de los adultos en las manzanas censales alrededor de la casa. Es un promedio ecológico, no una medida del hogar: dice en qué tipo de barrio vive una familia, no cuán educada es esa familia. El artículo es explícito en que esto sostiene una afirmación sobre la dirección de la incidencia, que las familias menos aventajadas ganan más, y no sobre su magnitud.",
  "wg.read.p3": "Por qué la línea de este modelo es plana y la del artículo no. El artículo da dos razones para el gradiente, y este modelo solo tiene una. La primera es la ubicación: las familias mejor acomodadas viven más cerca de las escuelas que la gente quiere, así que tienen menos que ganar con una regla que mira más allá de la proximidad. Este modelo la tiene, porque sus hogares vienen de la grilla de densidad real y sus escuelas son las reales. La segunda es el gusto: el artículo estima que la aversión a la distancia crece con la escolaridad del barrio, así que las familias mejor acomodadas ya obtenían lo que valoraban bajo la regla de distancia. Este modelo no la tiene, porque el gusto por la distancia de cada familia se genera de una misma distribución sin importar dónde vive. Con la ubicación sola, el gradiente aquí no se mueve. Lee la línea plana como una afirmación sobre lo que se le dio a este modelo, no sobre Manta.",
  "wg.read.p4": "Dos límites más. Las familias sintéticas heredan el valor de la celda de 300 m de la que se generaron, así que todas las de una celda comparten un valor socioeconómico y el gráfico no muestra variación dentro del barrio. Y los grados de ingreso son donde un gradiente significaría algo: en el congestionado Primero de básica la ganancia agregada es casi nula y el artículo encuentra allí un gradiente indistinguible de cero; en Inicial 1 imprime las medias por cuartil pero no lee un gradiente cuando el remuestreo respeta la manzana censal; por eso acota la lectura distributiva solo a Inicial 2.",
  "wg.cta.sim": "Cambia el mercado y míralo moverse →", "wg.cta.apply": "Míralo desde una familia →", "wg.cta.story": "Lee el argumento →",
  // ----------------------------------------------------------------- apply
  ...
  "ap.s1.note": "Las casas típicas se generan dentro de la grilla de densidad publicada de hogares de postulantes, así que tus vecinos están donde las familias viven de verdad. Tu postulación nunca sale del navegador: nada de lo que escribes aquí se guarda ni se envía. La página sí recuerda tu elección de idioma, y los mosaicos del mapa se piden a OpenStreetMap.",
  ...
  "sv.read.p1": "Las listas cortas no son un fracaso en encontrar alternativas. La mayoría de las familias con una sola escuela dice que no hay una escuela fiscal aceptable lo suficientemente cerca, o que está segura de un cupo; solo cerca del 6% menciona dificultad para encontrar escuelas. Eso es lo que permite al artículo leer las listas cortas como escasez de opciones cercanas aceptables y no como incapacidad de ubicarlas, con una cautela que el propio artículo señala: la pregunta pedía una sola razón principal, así que las fricciones de información también pueden haber contribuido. El artículo no deriva de esto ninguna cota. Se abstiene de firmar el signo del efecto neto del conocimiento limitado sobre la comparación de bienestar, y evalúa solo el valor de actuar sobre las preferencias que las familias ya tienen, no el de ayudarlas a descubrir opciones que aún no conocen.",
  ...
  "cal.read.p3": "Qué no coincide. Cuatro brechas, y los parámetros detrás de ellas son los del artículo. Tres son el precio de los conjuntos de consideración pequeños: las familias que eligen una escuela distinta de la más cercana no se desvían tanto como las reales, unos 0,27 km frente a 0,6, así que la ganancia de bienestar en kilómetros del nivel de ingreso es cerca del 72% de la del artículo; allí la proporción que pone primero la más cercana es 59% frente a 65%; y la regla de distancia ubica a más familias en una escuela que habían listado que en el artículo, 73% frente a 65%, que es la mayor discrepancia y favorece la base desde la que arranca toda la comparación. La cuarta va en sentido contrario: en el congestionado Primero de básica la ganancia sintética es mucho mayor que la casi nula del artículo, no menor, y la «proporción del rango recuperada» de ese grado no es comparable en absoluto, porque en el artículo ese cociente está casi indefinido allí, con un intervalo de confianza que va de −77% a +36%, mientras que en el mundo sintético, donde las preferencias son completas, está bien definido. El relato de la congestión vive en la proporción en primera opción, que sí coincide. Una brecha es de otra clase y no es cuestión de grado: el modelo no reproduce en absoluto el gradiente socioeconómico del artículo, y la <a href='../gains/'>página de quién gana</a> lo muestra junto al del artículo y explica por qué no puede.",
  ...
  // ------------------------------------------------------- landing card tags
  "tag.apply": "POSTULA", "tag.story": "RELATO", "tag.gains": "QUIÉN GANA", "tag.sim": "SIMULADOR", "tag.toy": "MERCADO DE JUGUETE", "tag.game": "JUEGO", "tag.survey": "ENCUESTA", "tag.figure": "FIGURA", "tag.downloads": "DESCARGAS", "tag.calibration": "CALIBRACIÓN", "tag.appendix": "APÉNDICE",
  // --------------------------------------------------------------- landing
  ...
  "land.gains.h": "¿Quién gana? →",
  "land.gains.p": "La ganancia de actuar sobre las preferencias, familia por familia: un mapa de quiénes ganan y quiénes pierden, y la ganancia frente a la escolaridad del barrio. La incidencia coincide con la del artículo; el gradiente progresivo no, y por qué es lo interesante.",
