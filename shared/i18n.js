...
const ES = {
  ...
  "wg.h1": "¿Quién gana?",
  "wg.lede": "El promedio esconde a quién le toca. En el mapa, familia por familia: quiénes quedan mejor con la asignación por preferencias que con la regla de distancia y quiénes no. Este mercado sintético reproduce de cerca la incidencia del artículo: concentrada en la mitad de las familias, con la mayor parte del resto sin cambio. No reproduce el otro hallazgo distributivo del artículo, que las ganancias caen con el nivel socioeconómico de la familia, y el gráfico pone ambos lado a lado porque vale la pena saber por qué no puede.",
  ...
  "wg.grad.note": "En el artículo la ganancia cae con el nivel socioeconómico: <b>{paper} km</b> del cuartil más bajo al más alto (intervalo del 95%: {lo} a {hi}). En este modelo el mismo contraste es <b>{here} km</b>, más o menos {se}, es decir <b>plano</b>. Eso es lo que cabe esperar de una población sintética: ver abajo.",
  "wg.grad.note4": "El gradiente del artículo para este grado es {paper} km y no se distingue de cero (intervalo del 95%: {lo} a {hi}); aquí la ganancia agregada también es casi nula, y el artículo acota su lectura distributiva a los dos grados de inicial. En este modelo el contraste es {here} km, más o menos {se}.",
