...
const ES = {
  ...
  "wg.read.p3": "Por qué la línea de este modelo es plana y la del artículo no. Los gustos y el largo de lista de cada familia sintética se generan de la misma distribución estimada, con independencia de dónde vive. La única vía por la que el nivel socioeconómico puede tocar la ganancia aquí es la geografía: qué escuelas quedan cerca y cuán llenas están. Esa vía por sí sola no produce ningún gradiente medible. El gradiente del artículo se estima sobre familias reales, así que dice que las familias de barrios menos aventajados ganan más de lo que la geografía sola predeciría, que es justamente la parte que un modelo ciego al nivel socioeconómico no puede inventar. Lee la línea plana como una afirmación sobre este modelo, no sobre Manta.",
