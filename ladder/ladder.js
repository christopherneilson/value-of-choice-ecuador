...
const TXT = () => ({
  ...
  ny3: [t("lad.ny3.h", "Beyond ordinal efficiency"), t("lad.ny3.b", "From the ordinally Pareto-efficient assignment \u2014 which is not itself stable \u2014 to the unconstrained utilitarian optimum: 16.4% (3.11 miles). Only cardinal information could close it.")],
